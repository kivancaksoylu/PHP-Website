	...
	<orta>
	   <div class="programFoto">
		<img src="blenderProgram.jpg" alt="" class="blender" id="blenderProgram" style="display: none;">
		   <img src="unityProgram.png" alt="" class="unity" id="unityProgram" style="display: none;">
		   <img src="substanceProgram.jpg" alt="" class="substance" id="substanceProgram" >
		</div>
		...
		<h1 class="blender" id="blenderYazi" style="display: none;">Blender</h1>
			...
			<h1 class="unity" id="unityYazi" style="display: none;">Unity</h1>
			<p class="unity" id="unityYaziP" style="display: none;">
			...
			<h1 class="substance" id="substanceYazi" >Substance Painter</h1>
			<p class="substance" id="substanceYaziP">
